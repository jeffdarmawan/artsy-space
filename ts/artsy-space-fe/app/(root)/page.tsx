    ...
    <>
      ...
      >
        ...
        <div className="flex h-auto w-full items-end justify-center overflow-hidden lg:order-1">
          <Image
            src="https://images.unsplash.com/photo-1579762715118-a6f1d4b934f1?ixlib=rb-4.0.3&q=85&fm=jpg&crop=entropy&cs=srgb&dl=boston-public-library-YoK5pBcSY8s-unsplash.jpg&w=2400"
            // width={600}
            // height={761}
            alt="frontpage-image"
            layout="fill"
